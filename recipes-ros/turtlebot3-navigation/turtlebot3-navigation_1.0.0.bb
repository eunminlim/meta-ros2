...
RDEPENDS_${PN} = "actionlib map-server rosconsole-bridge amcl move-base-msgs roslaunch move-base urdf kdl-parser nav-core urdfdom urdf orocos-kdl robot-state-publisher xacro yaml-cpp base-local-planner clear-costmap-recovery dwa-local-planner map-server navfn ros2-geometry-msgs rotate-recovery tf2-msgs"
