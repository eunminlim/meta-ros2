...
inherit webos_enhanced_submissions autotools-brokensep lib_package pkgconfig
inherit webos_machine_dep

DEPENDS = "wayland virtual/libgles2 udev libpng webos-wayland-extensions pmloglib glib-2.0 libwebos-helpers libxkbcommon libpbnjson"

WEBOS_VERSION = "2.0.4-86_86d1f33812b1811ced47ed207d63f7d459176387"
PR = "r22"
...
do_install_append() {
    rm -vf ${D}/${bindir}/sdl2-config
    rmdir -v --ignore-fail-on-non-empty ${D}/${bindir}
}
